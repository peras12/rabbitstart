...
const { Keypair, Transaction, Connection, PublicKey } = require("@solanaeb3.js");
const { createTransferCheckedInstruction, TOKEN_PROGRAM_ID, getOrCreateAssociatedTokenAccount } = require("@solana/s-token");
const bs58 = require("bs58");

// Replace with your RPC URL
const connection = new Connection("https://api.testnet.sa.com", "confirmed");
...
async function transfer(receiptAddress, amount) {
  try {
    ...
    // Define sender
    const senderPublicKey = new PublicKey('79v2ySPtaouHaoH6EPrARonyKy4F4HsT7nvbEt4');
