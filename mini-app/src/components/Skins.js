...
import defaultCoin from "../images/deneme.jpg";
...
const images = [
  ...
  { name: "Orange Skin", price: "1000 Points", src: OrangeCoin },
  { name: "Guard Skin", price: "2000 Points", src: GuardCoin },
            ...
            {images.map((image, index) => (
              <Grid key={index} item xs={6}>
                ...
                >
                  ...
                  >
                    {userCurrentSkin === index + 1
                      ? "Selected"
                      : userSkins.includes(index + 1)
                        ? "Select"
                        : "Buy"}
                  </Button>
                </Paper>
