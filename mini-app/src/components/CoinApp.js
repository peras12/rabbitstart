...
import NewpageModal from "./Newpage";
      ...
      {/* Buttons */}
            ...
            >
              <GoldButton variant="contained" onClick={() => setOpenFriends(true)}>
                <span
                  style={{ marginRight: "5px", marginTop: "5px", color: "#0a0a0a" }}
                >
                  Frens
                </span>{" "}
                <img
                  ...
                  width="10"
                  height="10"
                  src="https://cdn-icons-png.flaticon.com/512/7440/7440112.png"
                  alt="paint-palette"
                />
              </GoldButton>
              <Divider
              ...
              >
                ...
                <img
                  ...
                  width="10"
                  height="10"
                  src="https://img.icons8.com/external-anggara-flat-anggara-putra/64/external-podium-school-anggara-flat-anggara-putra-2.png"
                  alt="external-podium"
                />
              </GoldButton>
              <Divider
              ...
              <GoldButton variant="contained" onClick={() => setOpenSkins(true)}>
                ...
                <img
                  ...
                  width="10"
                  height="10"
                  src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQz7IkhUsGJHMnhR0Dp2iBK7ucPrJ_YyHnQ4w&shttps://img.icons8.com/fluency/48/paint-palette.png"
                  alt="paint-palette"
                />
              </GoldButton>
              <Divider
              ...
              >
                ...
                <img
                  ...
                  width="25"
                  height="25"
                  src="https://cdn-icons-png.freepik.com/512/7471/7471113.png"
                  alt="flash-on"
                />
              </GoldButton>
            </Box>
      ...
      >
        ...
        >
          ...
          <Typography
            ...
            sx={{ mt: 1, fontFamily: "avenir", fontSize: "16px" }}
            component="p"
          >
          ...
          <Typography
            ...
            component="p"
          >
            minimum withdraw: 5000 points minimum withdraw: 5000 points minimum
            withdraw: 5000 points minimum withdraw: 5000 points minimum
            withdraw: 5000 points minimum withdraw: 5000 points minimum
            withdraw: 5000 points minimum withdraw: 5000 points minimum
            withdraw: 5000 points minimum withdraw: 5000 points minimum
            withdraw: 5000 points minimum withdraw: 5000 points minimum
            withdraw: 5000 points
          </Typography>
